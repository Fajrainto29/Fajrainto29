...
int main()
{
    ...
    while (1)
    {
        cout<<endl<<"Nama : Muhammad Fajrianto";
        cout<<endl<<"NPM : G1A019037"<<endl;         
        cout<<endl<<"-----MENU-----"<<endl;        
        cout<<endl<<"1. Buat/Create"<<endl;
        cout<<"2. Masukkan Data/Insert"<<endl;
        cout<<"3. Insert After/Masukkan Setelah"<<endl;
        cout<<"4. Delete/Hapus "<<endl;
        cout<<"5. Display/Tampilkan Data "<<endl;
        cout<<"6. Count/Hitung"<<endl;
        cout<<"7. Reverse/Balikkan "<<endl;
        cout<<"8. Quit/Keluar"<<endl;
